...
import { SimpleFooter } from "@/components/sections/footer";
    ...
    <>
      <div className="">
        <main className="container py-4">
          <Heading title="Oops! 😯 Not Found!" textClassName="text-4xl">
            <BackButton />
          </Heading>
                ...
                <div className="col-sm-12 col-md-12">
                  ...
                  >
                    <g id="OBJECTS">
                      ...
                      <g
                        id="zero"
                        className="transform origin-bottom transform-box-fill-box"
                      >
                        <path
                          id="Vector_25"
                      ...
                      <g id="Group_8">
                        <g id="Group_9">
                          ...
                          <g
                            id="handboy"
                            className="animate-infinite-swing transform transform-origin-[98% 98%] transform-box-fill-box"
                          >
                            <path
                              id="Vector_32"
                      ...
                      <g id="Group_13">
                        <g id="Group_14">
                          ...
                          <g
                            id="girllight"
                            className="animate-infinite-swing transform transform-origin-[0% 97%] transform-box-fill-box"
                          >
                            <path
                              id="Vector_102"
                          ...
                          <g
                            id="hairgirl"
                            className="animate-infinite-swinghair transform transform-origin-[60% 0%] transform-box-fill-box"
                          >
                            <path
                              id="Vector_108"
